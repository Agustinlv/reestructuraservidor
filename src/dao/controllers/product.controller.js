...
export const updateProduct = async (req, res) => {
    ...
    //Chequeo que el código de producto no le pertenezca a otro producto. Para eso busco un producto con el mismo code que pasaron en el body, pero distinto id
    try {
